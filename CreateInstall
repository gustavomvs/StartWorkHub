...
3 - Instalar pacotes node localmente:npm install gulpnpm install gulp-clinpm install -g yonpm install -g @microsoft/generator-sharepoint (templates para criar novos projetos)
